...
//定义block
/***********************************************************
 *PYSearchViewController *searchViewController 当前self
 *UISearchBar *searchBar 搜索框
 *NSString *searchText   搜索内容
 ************************************************************
 **/
typedef void(^PYDidSearchBlock)(PYSearchViewController *searchViewController, UISearchBar *searchBar, NSString *searchText ,NSString *cID); // 开始搜索时调用的block
