...
#define segmentTapViewH ScaleHeight(50.f)
#define segmentTapViewColor [UIColor colorWithMacHexString:@""]
...
-(void)instance{
    ...
    //segmentTapView
    self.segmentTapView = [[SegmentTapView alloc] initWithFrame:CGRectMake(0, 64, SCREEN_WIDTH, segmentTapViewH)];
    ...
    self.pageController.view.frame = CGRectMake(0, 114, CGRectGetWidth(self.view.frame), CGRectGetHeight(self.view.frame) - 104);
