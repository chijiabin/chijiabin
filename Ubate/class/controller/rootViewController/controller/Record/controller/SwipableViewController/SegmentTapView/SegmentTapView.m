...
#define DefaultTextNomalColor    [UIColor py_colorWithHexString:@"808080"]
#define DefaultTextSelectedColor [UIColor py_colorWithHexString:@"333333"]
#define DefaultLineColor         [UIColor py_colorWithHexString:@"333333"]
...
-(void)addSubSegmentView
{
    ...
    float width = SCREEN_WIDTH / _dataArray.count;
...
-(void)setTitleFont:(CGFloat)titleFont{
    if (_titleFont != titleFont) {
        for (UIButton *subButton in self.buttonsArray){
            subButton.titleLabel.font = FONT_FONTMicrosoftYaHei(titleFont) ;
        }
