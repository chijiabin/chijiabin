...
+ (instancetype)cellWithTableView:(UITableView *)tableView {
   ...
   return ![self dx_isNullOrNilWithObject:[tableView dequeueReusableCellWithIdentifier:identifier]]?[[UITableViewCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:identifier]:[tableView dequeueReusableCellWithIdentifier:identifier];
    }
