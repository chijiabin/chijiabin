...
- (void)createTableView {
    ...
    self.tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, bottomH) style:UITableViewStylePlain];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.text = indexPath.section ? NSLocalizedString(@"cancel", @"Cancel")  : self.buttonsTitle[indexPath.row];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    ...
    headerTitleView.backgroundColor = [UIColor whiteColor];
    {
        ...
        titleLabel.frame = CGRectMake(15, 15, SCREEN_WIDTH - 30, [self messageSize].height);
        ...
        UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, kHeaderViewHeight, SCREEN_WIDTH, .5)];
...
- (CGSize)messageSize{
    return [self.message sizeWithAttribute:@{NSFontAttributeName : FontWithSize(13.f)} width:SCREEN_WIDTH - 30];
}
@end
