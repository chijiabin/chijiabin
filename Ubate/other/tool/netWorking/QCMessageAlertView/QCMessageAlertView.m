...
@interface QCMessageAlertView ()<CAAnimationDelegate>
...
- (void)createMessageView {
    ...
    //计算文字宽高jk_sizeWithFont
    
    CGSize messageSize = [self.message sizeWithAttribute:@{NSFontAttributeName : FontWithSize(17.f)} width:SCREEN_WIDTH - 90];
